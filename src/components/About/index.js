    ...
    <div className="" style={{ minHeight: "95vh" }}>
      <div className="text-center col-10 col-md-9 col-lg-8 m-auto py-5">
        ...
        <p className="text-white-50 fs-6 fw-bold  lh-sm">
          ...
          encourage our readers to engage with our content, share their
          thoughts, and contribute to the conversation. Your voice matters here.
          Expert Contributors: Our team of writers consists of industry experts,
          passionate hobbyists, and creative thinkers who are dedicated to
          delivering high-quality content. Regular Updates: We continuously
